...
extern  char ** authorization_1(char **, CLIENT *);
extern  char ** authorization_1_svc(char **, struct svc_req *);
#define access 2
...
extern  auth_token_struct * approve_req_token_1_svc(auth_token_struct *, struct svc_req *);
extern int authorization_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define authorization 1
extern  char ** authorization_1();
extern  char ** authorization_1_svc();
#define access 2
